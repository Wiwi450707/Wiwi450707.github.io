...
@import url("https://wiwi450707.github.io/importwiwi.css");

body {
    /* font options */
    --font:  "Delius", cursive; /* change to '' for default discord font */
    --code-font: "Delius", cursive; /* change to '' for default discord font */
    ...
    --dms-icon-svg-url: url('https://raw.githubusercontent.com/Wiwi450707/Wiwi450707.github.io/75a655964c5fd95352ad81a04ffb733b639384fb/home.svg'); /* icon svg url. MUST BE A SVG. */
    --dms-icon-svg-size: 125%; /* size of the svg (css mask-size property) */
    --dms-icon-color-before: var(--icon-secondary); /* normal icon color */
    --dms-icon-color-after: var(--red-1); /* icon color when button is hovered/selected */
    ...
    --dms-background-image-url: url('https://i.imgur.com/IsxCWCV.jpeg'); /* url of the background image */
    ...
    --background-image-url: url('https://clearvision.github.io/images/sapphire.jpg'); /* url of the background image */
...
:root {
    ...
    --bg-4: rgba(22, 24, 29, 0.808); /* main background color */
...
/* --- Début : TON FICHIER INITIAL (inchangé) --- */
/* …tout ton code existant ici… */
/* --- Fin de TON FICHIER INITIAL --- */



/*==================================================================
  AJOUT : icône DM distincte, taille personnalisable + couleur rouge
==================================================================*/

/* 1. Variables globales */
body{
    --dms-icon-svg-url-dm: url('https://raw.githubusercontent.com/Wiwi450707/Wiwi450707.github.io/8e395daf56e4d85e54b530a9172c3b1d3074584f/lock.svg');
    --dms-icon-svg-size: 100%;
    --dms-icon-svg-color: var(--red-1);   /* <— rouge vif ; ajuste si besoin */
}

/* 2. Bouton « Home/DMs » sélectionné = on applique icône, taille ET rouge */
@container body style(--custom-dms-icon: custom) {
  .wrapper__6e9f8[data-list-item-id='guildsnav___home'][aria-selected='true'] > .childWrapper__6e9f8::before{
      mask-image: var(--dms-icon-svg-url-dm);
      mask-size: var(--dms-icon-svg-size);
      background: var(--dms-icon-svg-color);  /* <— devient rouge */
      transform: scale(1);
  }

  /* Animation de survol (facultative) */
  .wrapper__6e9f8[data-list-item-id='guildsnav___home'][aria-selected='true']:hover > .childWrapper__6e9f8::before{
      transform: scale(1.1);
  }
}
